...
class AbsenceOption extends StatelessWidget {
  String valeur;
  navPush(BuildContext context,String valeur){
    Navigator.push(context,MaterialPageRoute(builder: (context)=> ListAbsenecGroupeState(valeur)));
  }
  @override
