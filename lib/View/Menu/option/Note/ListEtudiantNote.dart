...
class etudNoteState extends StatefulWidget {

  final String valeur;
  etudNoteState(this.valeur);
  State<StatefulWidget> createState(){

    return etudNote(this.valeur);
  }
}
class etudNote extends State<etudNoteState>{
  final String valeur;
  etudNote(this.valeur);
              ...
              children: snapshot.data
                ...
                FadeAnimation(1.0,InfoCard(text: data.nom+" "+data.prenom, icon: Icons.account_circle, onPressed: () async {
                  Navigator.of(context).push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => NoteTable(data.email.toString()),
                      ));
                })),
