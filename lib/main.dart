...
import 'package:mobileflutter/Test/CardWidget.dart';
import 'package:mobileflutter/Test/DataTable.dart';
import 'package:mobileflutter/Test/test.dart';
import 'package:mobileflutter/View/Profile/profile.dart';
import 'package:page_transition/page_transition.dart';
import 'View/Animation/Animation.dart';
import 'View/View/LoiginPage.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      //home: Profile(1,"mohamed","kammoun","mohamed.kamoun@ensi-uma.tn",24444943),
        home: HomePage()
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 15,),
                  FadeAnimation(1.3, Text("Application Web et Mobile De \nl'École Nationale Des Sciences De l'Informatique.",
